...
Release candidate: iOS `0.2` / build `1`
...
- App Review contact details are filled only in Apple's private required review
  ...
  any public page.
- Review notes for the next candidate describe the exact `0.2` build: no login,
...
This audit passes for `0.2` / build `1`. Before submission, verify the selected
