...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Today / loaded card front | `Design/Approved/today-loaded-front-c5b-es-runtime.png` | iPhone 15 Pro simulator, 1179 x 2556 px | Portrait | Spanish | 2026-08-26 | `528a0dbff0fc4ff80dd9b1d1bda5a89ccf14e0750d74e49112ab2bf9de62c16e` | `Design/Comparisons/today-c5b-runtime-comparison.png`; run `32963500029`, commit `95d28aa` | Preserve the complete stationary Today composition and C5B's thin warm-gold outer line, inset hairline, slightly squarer geometry, and engraved crescent/star corner motifs. Keep the larger measured reading, direct sign selection, unframed Settings gear, Save outside the card, matching turn icon, and tab breathing room. Accessibility Dynamic Type may scroll. |
| Today / loaded card back, provider data | `Design/Approved/today-loaded-back-provider-c5b-es-runtime.png` | iPhone 15 Pro simulator, 1179 x 2556 px | Portrait | Spanish | 2026-08-26 | `6d860c08d411406e7e0c596fdd967732e15a580beb2a15fdba22588b27350fb3` | Run `32963500029`, commit `95d28aa`; shared-frame compact evidence recorded below | Preserve every provider-authored focus, keyword, score, lucky, Moon, and sign-essence field and use the exact same C5B physical border as the front. Preserve the matching `arrow.clockwise`; Reduce Motion may replace the 3D turn with a short fade. |
