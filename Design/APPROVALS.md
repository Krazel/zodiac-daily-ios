...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Today / loaded card front | `Design/Approved/today-large-card-front-c6-approved.png` | iPhone 15 Pro full-screen proposal, 853 x 1844 px | Portrait | Spanish | 2026-08-31 | `71643dffe4f8f5e662dc50d536a436ed5ec5f396643c6b1d9930565963aad966` | `Design/Comparisons/today-large-card-front-c6-es-runtime.png`, run `33343386120`, commit `b41e6dc`, SHA-256 `fba535c925685838ec9d1edecb56e441174cb8cb6090584eb030712710eb06dc` | Remove the sign selector from Today and keep sign changes in Settings. The enlarged stationary card begins directly below the date, preserves C5B's double warm-gold engraved frame, and contains a quiet sign identity rather than a button. Preserve the large illustration, dedicated dark reading zone, comfortable body type, Save outside the card, matching turn cue, and full bottom navigation without regular scrolling. |
| Today / loaded card back, provider data | `Design/Approved/today-large-card-back-c6-approved.png` | iPhone 15 Pro full-screen proposal, 853 x 1844 px | Portrait | Spanish | 2026-08-31 | `e88b175d8ee23cf92d08d59052335b341c8c009bddb624feb26e63d617a35230` | `Design/Comparisons/today-large-card-back-c6-es-runtime.png`, run `33343386120`, commit `b41e6dc`, SHA-256 `3744198c51f29116ccf1445bc4a7589435f964f863e3cb07c7705017db3c9843` | Use the same enlarged physical card and C5B frame as the front. Preserve every provider-authored focus, keyword, score, lucky, Moon, and sign-essence field, but render them in the approved readable grouped hierarchy. Keep the complete card, Save action, turn cue, and tabs visible without regular scrolling; Dynamic Type may use an accessibility fallback. |
...
| Saved / card detail | `Design/Approved/saved-detail-c5b-en-runtime.png` | iPhone 15 Pro simulator, 1179 x 2556 px | Portrait | English | 2026-08-26 | `78ba07ab200de8e0fc5d4a7db03692e3ab504acc31af2e968524893c00e997fd` | C6 shared-card evidence `Design/Comparisons/saved-detail-c6-es-runtime.png`, run `33343386120`, commit `b41e6dc`, SHA-256 `be53ff7f6516034dab00f532b79510d781a47829b4400d7d0ed53da574a5d4a4` | Preserve the complete saved card, shared C5B physical frame, native return path, and Remove from Saved outside the card. Native accessibility reflow is permitted. |
