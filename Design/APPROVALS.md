...
| Saved / card detail | `Design/Approved/saved-detail-c5b-en-runtime.png` | iPhone 15 Pro simulator, 1179 x 2556 px | Portrait | English | 2026-08-26 | `78ba07ab200de8e0fc5d4a7db03692e3ab504acc31af2e968524893c00e997fd` | Run `32963500029`, commit `95d28aa`; compact evidence `Design/Comparisons/saved-detail-c5b-es-iphone-se-runtime.png` | Preserve the complete saved card, shared C5B physical frame, native return path, and Remove from Saved outside the card. Native accessibility reflow is permitted. |
